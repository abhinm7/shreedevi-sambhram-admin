...
const Dashboard = () => {
  ...
  return (
    <>
      ...
      >
        <div 
          className={`dashboard-card ${activeView === 'overview' ? 'active' : ''}`} 
        ...
        <div 
          className={`dashboard-card ${activeView === 'events' ? 'active' : ''}`} 
          onClick={() => setView('events')}
        >
          All Events
        </div>
        <div 
          className={`dashboard-card ${activeView === 'Technical' ? 'active' : ''}`} 
          onClick={() => setView('Technical')}
        >
          Technical Events
        </div>
        <div 
          className={`dashboard-card ${activeView === 'Cultural' ? 'active' : ''}`} 
          onClick={() => setView('Cultural')}
        >
          Cultural Events
        </div>
        <div 
          className={`dashboard-card ${activeView === 'Special' ? 'active' : ''}`} 
