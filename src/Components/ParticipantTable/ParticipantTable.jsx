...
const ParticipantTable = ({ pdata, partStatus, name }) => {
 

  const downloadEventsXL = () => {
    {
      ...
      XLSX.writeFile(workbook, `${name}_list.xlsx`);
    }
  };
    ...
    <div>
      <div className="event-table">
        <div className="header">
          ...
          <div className="event-wise-participant-head">
            <p>{name}</p>

            <i
              onClick={downloadEventsXL}
